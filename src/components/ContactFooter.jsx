            ...
            <div className='w-full h-full hidden lg:flex'>
                <div className='flex items-center justify-center w-full h-[60vh] relative'>
                    <div className='w-full h-full lg:-mr-[11%] xl:-mr-[8%] overflow-hidden'>
                        <div className='w-full h-full flex flex-col items-start justify-center relative pl-4' style={{ backgroundImage: `url(${footer1})`, backgroundSize: 'cover', backgroundPosition: 'right' }}>
