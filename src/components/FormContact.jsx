...
const FormContact = () => {
    ...
    return (
        <>
            <ToastContainer />
            <section className='w-full max-w-6xl h-full mx-auto pb-[5rem] text-[12px] md:text-[14px] px-2 overflow-hidden'>
                <div className='grid grid-cols-1 md:grid-cols-2'>
                    <div className='w-full h-full' data-aos="fade-right" data-aos-duration="1200">
                        <hr className='h-[1rem] bg-[#411259]' />
                        <div className="bg-[#B7B7B7] px-4 md:px-10 py-6 rounded-sm  order-2 md:order-none">
                            ...
                            <form action="#" method="post" ref={form} onSubmit={sendEmail}>
                                ...
                                <div className="mb-2">
                                    <input type="text" id="name" name="name" placeholder='Name' required
                                        className="shadow appearance-none border rounded-full w-full py-3 px-4 text-[#000] leading-tight focus:outline-none focus:ring-1 focus:ring-[#411259] focus:border-[#411259]" />
                                </div>
                                <div className="flex flex-col md:flex-row md:space-x-4 mb-2">
                                    <div className="flex-1 mb-2 md:mb-0">
                                        <select id="sex" name="sex" required
                                            className="shadow border rounded-full w-full appearance-none py-3 px-4 text-[#000] 
                                ...
                                <div className="mb-2">
                                    <textarea id="address" name="address" rows="3" placeholder='Address' required
                                        className="shadow appearance-none border rounded-full w-full py-3 px-4 text-[#000] leading-tight focus:outline-none focus:ring-1 focus:ring-[#411259] focus:border-[#411259] resize-y"></textarea>
                                </div>
