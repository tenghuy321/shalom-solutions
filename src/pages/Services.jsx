              ...
              {applications
                ...
                .map(({ id, label, myClass }) => (
                  <button
                    ...
                    className={`flex items-center hover:transform hover:-translate-y-[8px] transition-transform duration-300 ease-in-out justify-center bg-gradient-to-r from-[#8B27BF] to-[#F7E8FF] text-[#411259] text-center py-4 px-4 rounded-full w-full min-h-[64px] text-[12px] font-[500] shadow ${myClass}`}
                  >
                    {label}
                  </button>
                ))}
            ...
            <div className="hidden lg:flex flex-col items-center text-center max-w-[300px]" data-aos="fade-up" data-aos-duration="1400">
              <div className="w-full h-full flex items-center justify-center p-4">
                <img
                  src={WhatWeDo}
                  alt="Calculator"
                  className="w-full h-full object-contain hover:transform hover:-translate-y-[8px] transition-transform duration-300 ease-in-out"
                />
              </div>
              ...
              {applications
                ...
                .map(({ id, label, myClass }) => (
                  <button
                    key={id}
                    onClick={() => togglePopup(id)}
                    className={`flex hover:transform hover:-translate-y-[8px] transition-transform duration-300 ease-in-out items-center justify-center bg-gradient-to-r from-[#8B27BF] to-[#F7E8FF] text-[#411259] text-center py-4 px-4 rounded-full w-full min-h-[64px] text-[12px] font-[500] shadow ${myClass}`}
                  >
                    {label}
                  </button>
                ))}
