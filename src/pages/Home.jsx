...
const Home = () => {
  ...
  return (
    <>
          ...
          <div className="w-full h-full rounded-l-xl">
            <div className="testing2 w-full h-full relative overflow-hidden" style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover', backgroundPosition: 'left' }}>
              ...
              <div className='flex flex-col items-center pl-[14%] xl:pl-[13%] justify-center h-full text-[#411259]' data-aos="zoom-in-up" data-aos-duration="1200">
                ...
                <h1 className='text-[20px] leading-none pt-10'>Welcome to</h1>
                <p className='text-[70px] text-center font-bold max-w-[600px] leading-none my-2'>SHALOM</p>
                <p className='text-center font-[200] max-w-[600px] text-[30px] tracking-[8px] leading-none'>SOLUTION</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className='relative w-full max-w-7xl mx-auto h-full mt-[2rem] md:mt-[5rem] pb-[2rem] text-[12px] md:text-[14px] px-2 overflow-hidden'>
        <h1 className='text-[16px] md:text-[20px] text-[#411259] font-[600]' data-aos="fade-right" data-aos-duration="1200">At SHALOM SOLUTION CO., LTD. </h1>
