...
const profiles = [
  {
    ...
    description:
      "Mr. YEM VEY is the Managing Director/Founder of SHALOM SOLUTION CO., LTD, an accounting firm which offers specialized services in accounting solutions, tax declaration, and company registration. He was appointed as Launching Director in 2022 and is also a Golden Club Privilege member of BNI PP2. Moreover, he has led numerous initiatives to enhance business efficiency and transparency in financial reporting for startups and SMEs in Cambodia.",
  },
  {
    id: 2,
    imagePosition: "right",
    name: "Mrs. CHHOUN KANHA",
    title: "Finance/Accounting Director",
    description:
      "Mrs. Chhoun Kanha is an experienced Financial and Accounting professional with expertise in tax declaration, financial reporting, and audit management. As the Financial/ Accounting Director at SHALOM SOLUTION, she leads the company's accounting and tax strategies, ensuring accuracy and compliance.",
  },
  {
    id: 3,
    imagePosition: "left",
    name: "Ms. CHIM CHANMONY",
    title: "Operation Director",
    description:
      "Ms. Chanmony Chim is the Operations Director at Shalom Solution, where she leads human resources, sales, marketing, and customer service strategies. She plays a key role in business development, overseeing operations, conducting research, and identifying new market opportunities to drive growth. Additionally,",
  },
];
const About = () => {
  ...
  return (
    <>
        ...
        <div className="relative w-full h-full lg:-mr-[3%] xl:-mr-0">
          <div className="w-full text-[#fff] h-full flex flex-col relative" style={{ backgroundImage: `url(${background1})`, backgroundSize: 'cover', backgroundPosition: 'right' }}>
            ...
            <div className="flex flex-1 items-center justify-center">
              <h1 className="text-[70px] font-bold text-center lg:mr-[4rem]" data-aos="zoom-in-up" data-aos-duration="1200">About Us</h1>
            </div>
          </div>
        ...
        <div className='relative w-full h-full'>
          <div className='w-full h-[3rem] flex items-center justify-between px-4'>
            ...
            <div className='flex items-center space-x-2'>
              ...
              <a href="#">
                <img src={IG} alt="" className='w-[22px] h-[22px]' />
              </a>
      ...
      {/* vision && mission */}
      <section className='relative w-full max-w-6xl mx-auto h-full mt-[2rem] md:mt-[5rem] pb-[2rem] text-[12px] md:text-[14px] px-2'>
        <div className='flex flex-col md:flex-row items-start justify-between gap-4 text-[#411259] overflow-hidden' >
          <div data-aos="fade-right" data-aos-duration="1200" className='w-full md:w-1/2 space-y-4 p-4 md:p-10 hover:text-[#fff] hover:bg-[#411259] transition-all duration-300 ease-in-out rounded-lg'>
            <h2 className='text-[24px] sm:text-[30px] lg:text-[40px] font-[700]'>Mission</h2>
            <p className=''>Our mission is to be recognized as a leading provider of Accounting and Tax services, empowering local and foreign investors by ensuring legal compliance, timely tax submissions, and cost-effective solutions, while delivering essential documentation support.</p>
          </div>
          <div data-aos="fade-left" data-aos-duration="1200" className='w-full md:w-1/2 space-y-4 p-4 md:p-10 hover:text-[#fff] hover:bg-[#411259] transition-all duration-300 ease-in-out rounded-lg'>
            <h2 className='text-[24px] sm:text-[30px] lg:text-[40px] font-[700]'>Vision</h2>
            <p className=''>Our vision is to assist recognized enterprises in maintaining legal licenses, submitting taxes on time, reducing unnecessary expenditures, and providing necessary documents to support both local and foreign investors in achieving their financial goals.</p>
          </div>
        </div>
      </section>

      {/* core value */}
      <section className='w-full bg-[#411259]'>
        <div className='max-w-6xl mx-auto px-4 py-6 md:p-10 text-white'>
          <h1 className='text-[24px] sm:text-[30px] lg:text-[40px] font-[700] px-2 md:px-0' data-aos="fade-right" data-aos-duration="1200"> Core Values</h1>
          <div className='flex flex-col md:flex-row items-start justify-between gap-4 flex-wrap pt-4'>
            <div data-aos="fade-up" data-aos-duration="1200" className='w-full md:w-[48%] space-y-2 md:space-y-4 p-4 hover:text-[#411259] hover:bg-white transition-colors duration-300 rounded-lg'>
              <h2 className='text-[14px] md:text-[16px] font-[700]'>Reliability</h2>
              <p className='text-[12px] md:text-[13px]'>Count on us for consistent, accurate service that you can trust. We prioritize your peace of mind with every financial decision.</p>
            </div>
            <div data-aos="fade-up" data-aos-duration="1200" className='w-full md:w-[48%] space-y-2 md:space-y-4 p-4 hover:text-[#411259] hover:bg-white transition-colors duration-300 rounded-lg'>
              <h2 className='text-[14px] md:text-[16px] font-[700]'>Proven Expertise</h2>
              <p className='text-[12px] md:text-[13px]'>Leverage our extensive experience in tax preparation. Our skilled team provides tailored solutions to meet your specific needs.</p>
            </div>
            <div data-aos="fade-up" data-aos-duration="1400" className='w-full md:w-[48%] space-y-2 md:space-y-4 p-4 hover:text-[#411259] hover:bg-white transition-colors duration-300 rounded-lg'>
              <h2 className='text-[14px] md:text-[16px] font-[700]'>Reasonable Price</h2>
              <p className='text-[12px] md:text-[13px]'>Affordable excellence is our promise. Transparent pricing means you get the best value for your money.</p>
            </div>
            <div data-aos="fade-up" data-aos-duration="1400" className='w-full md:w-[48%] space-y-2 md:space-y-4 p-4 hover:text-[#411259] hover:bg-white transition-colors duration-300 rounded-lg'>
              <h2 className='text-[14px] md:text-[16px] font-[700]'>Expedited Service</h2>
              <p className='text-[12px] md:text-[13px]'>Fast, efficient solutions are our specialy. We help you meet deadlines without compromising quality.</p>
            </div>
          </div>
        </div>
      </section>

      <section className='w-full max-w-6xl mx-auto text-[12px] lg:text-[14px] px-4 py-10'>
        <div className='flex flex-col md:flex-row items-center justify-between gap-4 text-[#411259] overflow-hidden'>
          <div className='w-full md:w-1/4 h-full flex items-center justify-center' data-aos="fade-right" data-aos-duration="1200">
            <div className="w-40 h-40 lg:w-56 lg:h-56 bg-gray-600 rounded-full flex items-center justify-center text-white">

            </div>
          </div>
          <div className='w-full md:w-3/4 space-y-4 p-4 lg:p-8' data-aos="fade-left" data-aos-duration="1200">
            <h2 className='text-[24px] sm:text-[30px] lg:text-[40px] font-[700]'>Message from CEO</h2>
            <p className=''>At SHALOM SOLUTION, our Accounting and Tax team is committed to providing expert tax declarations and financial services designed to ensure compliance, accuracy, and strategic financial planning. With extensive knowledge of Cambodia tax laws, we specialize in delivering tailored accounting and tax solutions that foster business growth and financial stability. We offer clear, actionable advice on tax planning, preparation, and compliance, helping clients navigate complex regulations with ease. Our team is dedicated to delivering exceptional service, ensuring all financial matters are managed with efficiency and precision.</p>
          </div>
        </div>
      </section>

      <section className='w-full text-[12px] lg:text-[14px] px-4 bg-[#411259]'>
        <div className='flex flex-col md:flex-row items-end max-w-7xl mx-auto justify-between gap-4 text-[#fff] overflow-hidden'>
          <div className='w-full md:w-2/3 space-y-4 p-4 lg:p-8' data-aos="fade-right" data-aos-duration="1400">
            <h2 className='text-[24px] sm:text-[30px] lg:text-[40px] font-[700]'>Our Team</h2>
            <p className=''>At SHALOM SOLUTION, our Accounting and Tax team is committed to providing expert tax declarations and financial services designed to ensure compliance, accuracy, and strategic financial planning. With extensive knowledge of Cambodia tax laws, we specialize in delivering tailored accounting and tax solutions that foster business growth and financial stability. We offer clear, actionable advice on tax planning, preparation, and compliance, helping clients navigate complex regulations with ease. Our team is dedicated to delivering exceptional service, ensuring all financial matters are managed with efficiency and precision.</p>
          </div>
        ...
        {profiles.map((profile) => {
          ...
          return (
            <div data-aos="fade-up" data-aos-duration="1400"
              key={profile.id}
              className={`relative w-full max-w-5xl mx-auto text-white p-6 flex flex-col md:flex-row items-center gap-4 mt-20 md:mt-0 ${isLeft ? "md:pl-16 bg-[#F7ECFE]" : "md:pr-16 bg-[#411259]"
                }`}
            >
              <div
              ...
              >
                ...
                <p className="text-sm mb-2">{profile.title}</p>
                <p
                  className={`text-[12px] transition-all duration-300 ${!isExpanded ? "line-clamp-3" : ""}`}>
                  {profile.description}
                </p>
                <button
                  onClick={() => toggleExpanded(profile.id)}
                  className={`px-4 py-2 mt-4 rounded-lg ${isLeft ? "bg-[#411259] text-[#fff]" : "bg-[#fff] text-[#411259]"}`}
                >
