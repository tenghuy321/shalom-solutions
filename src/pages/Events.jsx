      ...
      <section className="hidden lg:flex w-full h-screen bg-gray-100 text-[12px]">
        <div className="relative w-full h-full overflow-hidden lg:-mr-[3%] xl:-mr-0">
          <div className="w-full text-[#fff] h-full flex flex-col relative" style={{ backgroundImage: `url(${background1})`, backgroundSize: 'cover', backgroundPosition: 'right' }}>
            ...
            <div className="flex flex-col flex-1 items-center justify-center text-center lg:mr-[4rem]" data-aos="zoom-in-up" data-aos-duration="1400">
              <h1 className="text-[70px] font-bold ">Our Events</h1>
              <p className='text-[14px] md:text-[16px]'>ThinkBiGG Advisors, IMU UNIVERSITY <br /> Salom solution and imu university</p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 mt-[2rem] md:mt-[5rem] pb-[6rem] gap-10 items-center justify-center px-4 overflow-hidden">
        <div className="text-start text-[#411259] order-2 lg:order-none" data-aos="fade-right" data-aos-duration="1400">
          ...
          <div className="flex flex-col space-y-2 text-[12px] md:text-[13px]">
            <h2 className='text-[13px] md:text-[14px] font-[700]'>Purpose: </h2>
            <p className="">This initiative provides Company Registration, Bookkeeping, and Work Permit Extension services for the Myanmar Business Network while facilitating MBA enrollment for members.</p>

            <h2 className='text-[13px] md:text-[14px] font-[700]'>Vision: </h2>
            <p className="">aimed at providing comprehensive business solutions and educational opportunities to Myanmar entrepreneurs and businesses seeking to expand into Cambodia.</p>

            <h2 className='text-[13px] md:text-[14px] font-[700]'>Mission: </h2>
            <p className="">To facilitate the entry and growth of Myanmar businesses in Cambodia by offering efficient company Registration, Bookkeeping, Work permit extension Visa services, and high-quality MBA programs.</p>

            <h2 className='text-[13px] md:text-[14px] font-[700]'>"Schedule a Consultation Today"</h2>
            <p className="">Take the first step towards securing your financial future. Our expert advisors are ready to guide you through the tax process. Click the button below to schedule a consultation and let us help you navigate the complexities of taxation.</p>
