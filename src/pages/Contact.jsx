    ...
    <>
      ...
      <section className="hidden lg:flex w-full h-screen bg-gray-100 text-[12px] xl:text-[14px]">
        <div className="relative w-full h-full lg:-mr-[3%] xl:-mr-0">
          ...
          <div className='w-full h-[3rem] flex items-center justify-center px-4 text-[16px] text-[#37104C]' data-aos="fade-right" data-aos-duration="1200">
            @Copyright 2025 Shalom Solution!
          </div>
        </div>
            ...
            <div className="w-full h-full relative overflow-hidden" style={{ backgroundImage: `url(${background2})`, backgroundSize: 'cover', backgroundPosition: 'left' }}>
              ...
              <div className='flex flex-col items-center pl-[14%] xl:pl-[13%] justify-center h-full text-[#411259]' data-aos="zoom-in-up" data-aos-duration="1200">
                <div className="flex items-center gap-4">
                  <img src={logo} alt="" className='w-12 xl:w-14 h-auto' />
                  <div className="text-[20px] xl:text-[25px] font-[700]">
                    <h1>Shalom Solution Cambodia Co., Ltd.</h1>
        ...
        <div className='relative w-full h-full'>
          ...
          <div className="w-full h-screen">
            <div className="w-full h-full flex items-center justify-center relative" style={{ backgroundImage: `url(${BgSmall})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
              ...
              <div className='flex flex-col items-center text-[#411259] px-4 sm:px-10 md:px-20'>
                <h1 className='text-[40px] font-[700] leading-none' data-aos="zoom-in-up" data-aos-duration="1200">Contact Us</h1>
                <div className='flex flex-col items-start h-full text-[#411259] pt-10' data-aos="zoom-in-up" data-aos-duration="1200">
                  <div className="flex items-start gap-2 md:gap-4">
                    <img src={logo} alt="" className='w-10 md:w-12 h-auto' />
                    <div className="text-[14px] md:text-[20px] xl:text-[25px] font-[600]">
                      <h1>Shalom Solution Cambodia Co., Ltd.</h1>
                      <p className="text-[12px] sm:text-[16px] font-[500]">ACCOUNTING & TAX SERVICE</p>
                    </div>
                  </div>
                  <h1 className='text-[12px] md:text-[14px] pt-4'>Take the first step towards securing your financial future. Our expert advisors are ready to guide you through the tax process. Click the button below to schedule a consultation and let us help you navigate the complexities of taxation.</h1>
          ...
          <div className='w-full h-[3rem] flex items-center justify-center px-4 text-[14px] text-[#37104C]'>
            @Copyright 2025 Shalom Solution!
          </div>
        </div>
      </section>
