  ...
  return (
    <>
      ...
      <section className='w-full h-full text-[12px] mt-[2rem] md:mt-[5rem] pb-[2rem]'>
        <div className="max-w-7xl ml-auto bg-[#2e0e4a] relative">
          {/* Top header bar */}
          <div className="px-4 py-4">
            <h1 className="text-base md:text-lg text-white font-semibold">Clients' Testimonials</h1>
          </div>

          {/* Content Box */}
          <div className="w-full flex flex-col md:flex-row bg-[#f5eaff] relative md:rounded-tr-[100px] left-0 xl:-left-[200px]">
            {/* Left Column (Text) */}
            <div className="w-full md:w-3/4 bg-[#f5eaff] py-4 md:py-6 px-4 md:px-10 space-y-2">
              ...
              <button
                ...
                className="mt-2 px-4 py-2 bg-[#37104C] text-white rounded-full hover:bg-[#4a1a66] transition-colors text-xs"
              >
                {isExpanded ? 'Read Less' : 'Read More'}
              </button>
            </div>

            {/* Right Column (Purple with circle) */}
            <div className="w-full md:w-1/4 flex items-center justify-center p-6">
              <div className="w-40 h-40 lg:w-56 lg:h-56 bg-gray-300 rounded-full relative flex items-center justify-center">
                <span className="text-white text-6xl absolute bottom-2 right-4">”</span>
              </div>
            </div>
          </div>
        </div>
